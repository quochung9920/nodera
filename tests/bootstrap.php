...
$registry->register_test_type( 'core/button', $common + array( 'text' => array( 'type' => 'string' ), 'url' => array( 'type' => 'string' ) ) );
$registry->register_test_type( 'core/image', $common + array( 'alt' => array( 'type' => 'string' ), 'url' => array( 'type' => 'string' ) ) );
